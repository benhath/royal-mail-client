...
class ManifestCarrierCodesRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['carrier_codes'] = isset($data['carrier_codes']) ? $data['carrier_codes'] : null;
     ...
     * Sets carrier_codes
     *
     * @param string[] $carrier_codes Carrier Codes<br />Must be valid system carrier codes.
     *
     * @return $this
     */
    ...
    public function setPostingLocation($posting_location)
    {
        if ((mb_strlen($posting_location) > 10)) {
            throw new \InvalidArgumentException('invalid length for $posting_location when calling ManifestCarrierCodesRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($posting_location) < 10)) {
            throw new \InvalidArgumentException('invalid length for $posting_location when calling ManifestCarrierCodesRequest., must be bigger than or equal to 10.');
        }
