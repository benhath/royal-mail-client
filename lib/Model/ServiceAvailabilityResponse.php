...
class ServiceAvailabilityResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'options' => '\Swagger\Client\Model\ServiceAvailabilityOption[]',
     ...
     *
     * @param string $weight_unit_of_measure Weight Unit of Measure<br />The unit of measure used for the Max Weights.<br />Will be the same as the Weight Unit of Measure received.
     *
     * @return $this
     */
     ...
     * Gets options
     *
     * @return \Swagger\Client\Model\ServiceAvailabilityOption[]
     */
     ...
     * Sets options
     *
     * @param \Swagger\Client\Model\ServiceAvailabilityOption[] $options Service Options<br />The available service options that can be used for the details provided.<br />Populated for successful responses only.
     *
     * @return $this
     */
