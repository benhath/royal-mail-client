...
class ServiceAvailabilityShipmentPackage implements ModelInterface, ArrayAccess
{
    ...
    public function setPackageOccurrence($package_occurrence)
    {
        ...
        if (($package_occurrence > 9)) {
            throw new \InvalidArgumentException('invalid value for $package_occurrence when calling ServiceAvailabilityShipmentPackage., must be smaller than or equal to 9.');
        }
        if (($package_occurrence < 1)) {
            throw new \InvalidArgumentException('invalid value for $package_occurrence when calling ServiceAvailabilityShipmentPackage., must be bigger than or equal to 1.');
        }
    ...
    public function setPackagingId($packaging_id)
    {
        if (!is_null($packaging_id) && (mb_strlen($packaging_id) > 70)) {
            throw new \InvalidArgumentException('invalid length for $packaging_id when calling ServiceAvailabilityShipmentPackage., must be smaller than or equal to 70.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length > 250)) {
            throw new \InvalidArgumentException('invalid value for $length when calling ServiceAvailabilityShipmentPackage., must be smaller than or equal to 250.');
        }
        if (!is_null($length) && ($length < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $length when calling ServiceAvailabilityShipmentPackage., must be bigger than or equal to 0.01.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (!is_null($width) && ($width > 250)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ServiceAvailabilityShipmentPackage., must be smaller than or equal to 250.');
        }
        if (!is_null($width) && ($width < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ServiceAvailabilityShipmentPackage., must be bigger than or equal to 0.01.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (!is_null($height) && ($height > 250)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ServiceAvailabilityShipmentPackage., must be smaller than or equal to 250.');
        }
        if (!is_null($height) && ($height < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ServiceAvailabilityShipmentPackage., must be bigger than or equal to 0.01.');
        }
