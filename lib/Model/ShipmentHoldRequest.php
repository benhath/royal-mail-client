...
class ShipmentHoldRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'reason_for_hold' => 'setReasonForHold'
    ];
    ...
    protected static $getters = [
        ...
        'reason_for_hold' => 'getReasonForHold'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reason_for_hold'] = isset($data['reason_for_hold']) ? $data['reason_for_hold'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reason_for_hold'] === null) {
            $invalidProperties[] = "'reason_for_hold' can't be null";
        }
        if ((mb_strlen($this->container['reason_for_hold']) > 30)) {
            $invalidProperties[] = "invalid value for 'reason_for_hold', the character length must be smaller than or equal to 30.";
        }
     ...
     * Sets shipment_id
     *
     * @param string $shipment_id Shipment Id<br />The tracking number or Unique Id of the shipment to hold.
     *
     * @return $this
     */
    public function setShipmentId($shipment_id)
    {
        if ((mb_strlen($shipment_id) > 21)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling ShipmentHoldRequest., must be smaller than or equal to 21.');
        }
        if ((mb_strlen($shipment_id) < 13)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling ShipmentHoldRequest., must be bigger than or equal to 13.');
        }
    ...
    /**
     * Gets reason_for_hold
     *
     * @return string
     */
    public function getReasonForHold()
    {
        return $this->container['reason_for_hold'];
    }

    /**
     * Sets reason_for_hold
     *
     * @param string $reason_for_hold Reason for Hold<br />Must match a Hold Reason set in Pro Shipping Maintenance / Hold Reasons.
     *
     * @return $this
     */
    public function setReasonForHold($reason_for_hold)
    {
        if ((mb_strlen($reason_for_hold) > 30)) {
            throw new \InvalidArgumentException('invalid length for $reason_for_hold when calling ShipmentHoldRequest., must be smaller than or equal to 30.');
        }

        $this->container['reason_for_hold'] = $reason_for_hold;
