...
/**
 * PackagingResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackagingResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PackagingResponse';
     ...
     * Sets packaging_id
     *
     * @param string $packaging_id Packaging Id<br />The Id of the Packaging Details involved in the request.
     *
     * @return $this
     */
    public function setPackagingId($packaging_id)
    {
        if (!is_null($packaging_id) && (mb_strlen($packaging_id) > 70)) {
            throw new \InvalidArgumentException('invalid length for $packaging_id when calling PackagingResponse., must be smaller than or equal to 70.');
        }
